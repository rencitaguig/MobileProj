 ...
 * @property {function(string): void} [onSearchSubmit]
 * @property {function(): void} [onCartClick]
 * @property {function(): void} [onWishlistClick]
 * @property {function(): void} [onProfileClick]
 * @property {function(): void} [onLoginClick]
 * @property {function(): void} [onRegisterClick]
 * @property {function(): void} [onLogoutClick]
